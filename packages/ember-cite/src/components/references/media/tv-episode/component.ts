...
interface TvEpisodeEntryArgs extends WebFields, ReferenceFields, Episode {
  parent: ReferencesComponent;
}

export default class TvEpisodeEntryComponent
  extends ReferencesBaseComponent<TvEpisodeEntryArgs>
  implements ProducedComponent
{
  reference: MediaReference;

  constructor(owner: unknown, args: TvEpisodeEntryArgs) {
    super(owner, args);
